...
#    if kanton is None and age_group is None:
#        exposures = {}
#        exposures['Under 75 years'] = Exposures()
#        exposures['Over 75 years'] = Exposures()
#        exposures['Under 75 years'].read_hdf5('input_data/exposures/exposures_mortality_ch_u75.h5')
#        exposures['Over 75 years'].read_hdf5('input_data/exposures/exposures_mortality_ch_o75.h5')

    if kanton == 'Zürich' and age_group is None:
        exposures = {}
